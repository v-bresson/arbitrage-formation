...
<title>ArcheryOps - Arbitrage — Gestion des stages</title>
...
<nav class="breadcrumb"><div class="breadcrumb-row"><a href="dashboard.php">Accueil</a><span class="sep">/</span><a href="formateur.php">Espace formateur</a><span class="sep">/</span><span class="current">Gestion des stages</span></div></nav>
<div class="header-spacer"></div>
<script src="assets/header-fix.js"></script>

<div class="page wide">
    <div class="panel" style="align-items:center;text-align:center;">
        <h2 style="margin:0;">Gestion des stages</h2>
        <p class="modal-hint" style="margin:0;">Ce module (organisation des stages de formation) arrive bientôt.</p>
